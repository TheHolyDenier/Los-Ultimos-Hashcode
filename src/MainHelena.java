...
public class MainHelena {
    private static String rutaLectura = "Los-Ultimos-Hashcode/e_so_many_books.txt";
...
//    }
    ...
    public static void escribirArchivo(List<Libreria> todosLibros) throws IOException {
        FileWriter fileWriter = new FileWriter(rutaEscritura, sobrescritura);
        PrintWriter printWriter = new PrintWriter(fileWriter);
        printWriter.printf("%s\n", todosLibros.size()); //TODO: cambiar por el objeto que sea
        for (Libreria libreria : todosLibros) {
